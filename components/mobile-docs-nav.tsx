...
export function MobileDocsNav({ isOpen, onClose }: MobileDocsNavProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 lg:hidden">
      <div className="fixed inset-y-0 left-0 w-80 max-w-[80vw] bg-[#2b2d31] dark:bg-[#1e1f22] overflow-y-auto">
        <div className="p-4 flex justify-between items-center border-b border-[#4f545c]/30">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-md text-gray-300 hover:bg-[#393c43]/50 dark:hover:bg-[#2f3136]/50"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
